                                    ...
                                    bool         touchpad_left_handed)
{
        ...
        if (device != NULL) {
                ...
                if (tap && !single_button) {
                        gint one_finger_tap = manager->settings_touchpad->get(KEY_TOUCHPAD_ONE_FINGER_TAP).toInt();
                        gint two_finger_tap = manager->settings_touchpad->get(KEY_TOUCHPAD_TWO_FINGER_TAP).toInt();
                        gint three_finger_tap = manager->settings_touchpad->get(KEY_TOUCHPAD_THREE_FINGER_TAP).toInt();
