...
static void remap_from_file()
{
    ...
    for(i = 0; i < mapNum; i++)
    {
        ret = find_touchId_from_name(pDpy, stMapInfo[i].cTouchName,
        ...
        {
            do_action(pDpy, touchId, stMapInfo[i].cMonitorName,True);
        }
    }
